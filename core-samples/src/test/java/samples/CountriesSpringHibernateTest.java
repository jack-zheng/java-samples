...
import samples.service.CountryService;
...
import static samples.service.CountryService.COUNTRY_INIT_DATA;

@ExtendWith(SpringExtension.class)
@ContextConfiguration(locations = "classpath:junit5-test.xml")
public class CountriesSpringHibernateTest {
    @Autowired
    ...
    public void testCountryListStartsWithA() {
        List<Country> countryList =
                countryService.getCountriesStartingWithA();
        assertNotNull(countryList);
